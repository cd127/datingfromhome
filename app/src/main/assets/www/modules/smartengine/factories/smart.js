angular.module('starter').factory('Smartengine', function ($sbhttp, $rootScope, Url, Application, Customer) {
    ...
    return factory;
}).run(function ($sbhttp, $ionicPlatform, $ionicHistory, $rootScope, Url, $timeout, Smartengine, $state, Application, Pages) {
   ...
   function call_ads() {
       Application.loaded.then(function () {
           // App runtime!
           var smartengine = _.find(Pages.features, {
               code: 'smartengine'
           });
           ...
           try {
               ...
               // Something went wrong while loading smartengine
               console.error("[SmartEngine] " + e.message);
           }
       });
