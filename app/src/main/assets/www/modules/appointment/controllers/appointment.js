...
///////////////////
...
}).controller('PaymentSuccessController', function($controller, $ionicHistory, $ionicPopup, $ionicScrollDelegate, $ionicTabsDelegate, Authorization,Customer, $ionicModal, AUTH_EVENTS, $rootScope, $scope, $stateParams,$translate, $compile, $state, Appointment, $timeout,Enterprisepaymentpro,$ionicLoading){
    ...
    $scope.getPaymentConfirm = function(app_data,token,payment_code){
      ...
      /*          $scope.goBack = function() {
                   console.log("go to back 2");
                    $ionicHistory.clearHistory();
                    $state.go('appointment-view', {value_id: $stateParams.value_id}, {reload: true});
                };*/
...
*/
    ...
    $scope.goBack = function() {
        ...
        $ionicHistory.clearHistory();
        $state.go('home', {value_id: $stateParams.value_id}, {reload: true});
   };
